      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        duration: 0.5
          ...
          delay: 0.2
            ...
            Turn your mystical expertise into a prosperous enterprise with our proven business strategies and guidance.
          </motion.p>
        </motion.div>
        ...
        duration: 0.5
          ...
          <h2 className="text-2xl font-bold mb-2 text-center">Start Your Transformation</h2>
          <p className="text-primary-foreground/80 mb-6 text-center">Fill out the form below to get started</p>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              field
                    ...
                    <FormControl>
                      <div className="flex">
                        ...
                        <Input type="tel" placeholder="Your WhatsApp number" className="bg-white text-black rounded-l-none" {...field} />
                      </div>
                    </FormControl>
                  </FormItem>} />
              ...
              <FormItem>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  field
                        ...
                        <FormControl>
                          <SelectTrigger className="bg-white text-black w-full">
                            <SelectValue placeholder={<Instagram className="w-4 h-4" />} />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
                  ...
                  <FormField control={form.control} name="handle" render={({
                  field
                }) => <FormControl>
                        <Input placeholder="@yourhandle" className="bg-white text-black col-span-2" {...field} />
                      </FormControl>} />
                </div>
              </FormItem>

              <button type="submit" className="w-full bg-white text-primary font-medium py-2.5 rounded-lg hover:bg-white/90 transition-colors mt-6">
                Get Started
              </button>
